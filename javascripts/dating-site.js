...
require(
  ...
  ["dependencies", "firebase", "login", "add-favorite", "get-templates", "load-profile", "adduser", "auth-storage", "logout", "adtnlinfo"], 
  function(dependencies, firebase,login, addFavorite, templates, profile,adduser,auth, logout, adtnlinfo) {
